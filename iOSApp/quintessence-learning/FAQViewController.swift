...
class FAQViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let items = [
            ...
            FAQItem(question: "How does changing notification time work?", answer: "Once the time is changed, the current notification time will be kept for one more question. Then the questions will come at the new specified time. The notifications will take 24 hours to register properly"),
            FAQItem(question: "When do I receive questions?", answer:"You will receive questions once a day at the time you specified. However, you will not receive questions on the weekends.")]
